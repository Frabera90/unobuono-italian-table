  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      if (mode === "signup") {
        ...
        toast.success("Account creato! Completa il setup del ristorante.");
      } else {
        ...
        <div className="rounded-2xl border-2 border-ink bg-paper p-6 shadow-[8px_8px_0_0_hsl(var(--ink))]">
          <div className="mb-5 flex gap-2 rounded-lg bg-cream-dark p-1">
            <button
              ...
              className={`flex-1 rounded-md py-2 text-sm font-bold uppercase tracking-wider transition ${mode === "login" ? "bg-paper text-ink shadow-sm" : "text-ink/60"}`}
            >
              Accedi
            </button>
            <button
              ...
              className={`flex-1 rounded-md py-2 text-sm font-bold uppercase tracking-wider transition ${mode === "signup" ? "bg-paper text-ink shadow-sm" : "text-ink/60"}`}
            >
              Registrati
            </button>
          </div>
          ...
          <button
            ...
            onClick={google}
            disabled={busy}
            className="mb-4 flex w-full items-center justify-center gap-3 rounded-lg border-2 border-ink bg-paper py-2.5 text-sm font-bold uppercase tracking-wider text-ink transition hover:bg-cream-dark disabled:opacity-50"
          >
          ...
          <p className="mt-4 text-center text-[11px] text-muted-foreground">
            Registrandoti accetti i termini del servizio.
          </p>
        </div>
